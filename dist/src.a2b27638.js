...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/darkmode-js/lib/darkmode-js.js":[function(require,module,exports) {
var define;
...
},{}],"src/darkmode.js":[function(require,module,exports) {
"use strict";
...
darkmode.showWidget();
},{"darkmode-js":"node_modules/darkmode-js/lib/darkmode-js.js"}],"node_modules/codejar/codejar.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/codejar/linenumbers.js":[function(require,module,exports) {
"use strict";
...
},{}],"src/codejar.js":[function(require,module,exports) {
"use strict";

var _codejar = require("codejar");
var _prismjs = _interopRequireDefault(require("prismjs"));
var _linenumbers = require("codejar/linenumbers");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var node = document.querySelector(".editor");
var rainbow = function rainbow(ch, i) {
  var red = Math.round(Math.sin(0.01 * i + 0) * 127 + 128);
  var green = Math.round(Math.sin(0.01 * i + 2 * Math.PI / 3) * 127 + 128);
  var blue = Math.round(Math.sin(0.01 * i + 4 * Math.PI / 3) * 127 + 128);
  return "<span style=\"color: rgb(".concat(red, ", ").concat(green, ", ").concat(blue, ")\">{ch}</span>");
};
var lolcat = function lolcat(editor) {
  var code = editor.textContent.split("").map(rainbow).join("");
  editor.innerHTML = code;
};
var jar = (0, _codejar.CodeJar)(node, lolcat);
jar.updateCode(function (editor) {
  var code = editor.textContent;
  editor.innerHTML = code;
});
var content = function content(editor) {
  var code = editor.textContent;
  editor.innerHTML = code;
};
jar.updateCode(content);
},{"codejar":"node_modules/codejar/codejar.js","prismjs":"node_modules/prismjs/prism.js","codejar/linenumbers":"node_modules/codejar/linenumbers.js"}],"src/codejar2.js":[function(require,module,exports) {
"use strict";

var _codejar = require("codejar");
//import { CodeJar } from "https://medv.io/codejar/codejar.js";

var highlight = function highlight(editor2) {
...
var jar2 = new CodeJar(editor, highlight);
function test() {
...
test();
},{"codejar":"node_modules/codejar/codejar.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
},{"./styles.css":"src/styles.css","./darkmode":"src/darkmode.js","./codejar":"src/codejar.js","./codejar2":"src/codejar2.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
